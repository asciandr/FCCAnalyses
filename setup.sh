...
#  fi
  ...
  #source /cvmfs/sw.hsf.org/key4hep/releases/latest/x86_64-centos7-gcc12.2.0-opt/key4hep-stack/*/setup.sh
...
#  fi
  ...
  export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/usatlas/u/vcavaliere/usatlasdata/bnl_local/FCCee/missing_libs/
else
